        ...
        >
            ...
            {!isAuthenticated ? (
              <>
                <div className="my-4 flex justify-center gap-2">
                  <Link
                    to={"/sign-up"}
                    className="flex justify-center items-center bg-[#72a24d] text-white text-xl font-bold hover:bg-white hover:text-black rounded px-4 py-2 transition-colors duration-300"
                  >
                    SignUp
                  </Link>
                  <Link
              ...
              <>
                <div
                  className="my-4 flex justify-center gap-4 w-full"
          ...
          <div>
            <div className="flex gap-2 items-center mb-2">
              <a
                href="https://github.com/devanshV18"
                className="bg-[#2c2c2c] text-stone-500 p-2 text-xl rounded-sm hover:text-blue-400"
              >
                <FaGithub />
              </a>
  
              <a
                href="https://www.instagram.com/verma_ji_7/profilecard/?igsh=amF5NWRvZ204YmFx"
                className="bg-[#2c2c2c] text-stone-500 p-2 text-xl rounded-sm hover:text-pink-500"
              >
                <RiInstagramFill />
              </a>
            </div>
            ...
            <Link
              to={"/contact"}
              className="text-white text-xl font-semibold hover:text-[#72a24d]"
            >
              Contact Us
            </Link>
            ...
            <p className="text-gray-400">
              Designed By <span className="text-white">Devansh Verma</span>
              <a
                href="https://www.linkedin.com/in/devansh-verma-822a20166/"
