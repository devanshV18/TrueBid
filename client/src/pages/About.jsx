  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        <div>
          <h1
            className={`text-[#72a24d] text-2xl font-bold mb-8 min-[480px]:text-4xl md:text-6xl xl:text-xl 2xl:text-6xl`}
          >
            About Us
          </h1>
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Founded by Devansh Verma, TrueBid was born out of a passion for
        ...
        <div>
          <p className="text-[#72a24d] text-xl font-bold mb-3">
            Thank you for choosing <span className='text-xl text-black font-extrabold'>
                True
            </span>
            <span className='text-xl text-[#72a24d] font-extrabold'>
                Bid™
            </span>{' '}. We look forward to being a part of
