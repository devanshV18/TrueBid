  ...
  return (
    <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col">
      <div className="text-[16px] flex flex-wrap gap-2 items-center mb-8">
        ...
        <FaGreaterThan />
        <Link to="/view-my-auctions" className="font-semibold transition-all duration-300 hover:text-[#72a24d]">My Auctions</Link>
      ...
      {loading ? (
        ...
        <div className="flex gap-12 flex-col 2xl:flex-row mt-8">
                ...
                auctionBidders.length > 0 ? (
                  auctionBidders.map((element, index) => (
                    <div key={index} className="py-5 flex items-center justify-between border-b border-gray-200">
                      ...
                      {index === 0 ? (
                        <p className="text-xl font-semibold text-green-600 flex-1 text-end">1st</p>
                      ) : index === 1 ? (
                        <p className="text-xl font-semibold text-blue-600 flex-1 text-end">2nd</p>
                      ) : index === 2 ? (
                        <p className="text-xl font-semibold text-yellow-600 flex-1 text-end">3rd</p>
                      ) : (
