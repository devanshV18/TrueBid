            ...
            {!isAuthenticated && (
              <>
                <div className="my-4 flex justify-center gap-2">
                  ...
                  <Link
                    to={"/sign-up"}
                    className="flex justify-center items-center bg-white border border-black text-black text-xl font-bold hover:bg-[#72a24d] hover:border-none hover:text-white rounded px-4 py-2 transition-colors duration-300"
                  >
                    SignUp
                  </Link>
                  <Link
